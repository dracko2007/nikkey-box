    ...
    return (
      <div className="fixed bottom-0 inset-x-0 z-[9998] p-4 animate-in slide-in-from-bottom duration-300">
        <div className="max-w-lg mx-auto bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
          <div className="h-1 bg-gradient-to-r from-violet-400 to-violet-400" />
          <div className="p-4 flex items-center gap-4">
            <img src="/icons/icon-72x72.png" alt="Nikkey Box" className="w-14 h-14 rounded-xl shadow-md flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-white font-bold text-sm leading-tight">Instalar Nikkey Box</p>
          ...
          <div className="px-4 pb-4 flex gap-2">
            ...
            <button
              ...
              className="flex-1 py-2 rounded-xl bg-purple-500 text-white text-sm font-bold flex items-center justify-center gap-2 hover:bg-violet-700 transition-colors"
            >
          ...
          <div className="p-5">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
                <div className="w-7 h-7 rounded-full bg-purple-100 text-violet-700 flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">1</div>
                <div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
                <div className="w-7 h-7 rounded-full bg-purple-100 text-violet-700 flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">2</div>
                <div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
                <div className="w-7 h-7 rounded-full bg-purple-100 text-violet-700 flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">3</div>
                <div>
                  <p className="text-sm font-semibold text-gray-800">Toque em "Adicionar"</p>
                  <p className="text-xs text-gray-500 mt-0.5">O ícone Nikkey Box aparece na tela inicial 🎉</p>
                </div>
              </div>
            </div>
            ...
            <button
              onClick={dismiss}
              className="w-full mt-4 py-2.5 rounded-xl bg-purple-500 text-white text-sm font-bold hover:bg-violet-700 transition-colors"
            >
              Entendi!
            </button>
          </div>
