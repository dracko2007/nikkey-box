          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="flex items-center gap-1 text-xs text-purple-500 hover:text-violet-700 mt-2 font-medium transition-colors"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-2 mt-4">
                <button
                  onClick={accept}
                  className="flex-1 bg-purple-500 hover:bg-violet-700 active:scale-95 text-white font-bold text-sm py-2.5 px-5 rounded-xl transition-all duration-200 shadow-sm"
                >
                  Aceitar todos
                </button>
                <button
