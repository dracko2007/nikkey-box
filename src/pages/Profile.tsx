      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="bg-gradient-to-r from-amber-400 to-violet-600 rounded-2xl p-6 lg:p-8 text-white shadow-elevated flex items-center justify-between">
              <div>
                      ...
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="text-right">
                          ...
                          <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${
                            ...
                            (order.status as string) === 'packing' ? 'bg-purple-100 text-orange-800' :
                            (order.status as string) === 'processing' ? 'bg-purple-100 text-orange-800' :
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-1">
                              ...
                              <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-bold border ${
                                isPending ? 'bg-purple-100 text-violet-800 border-purple-300'
