            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 min-w-0">
              ...
              <div className="lg:col-span-2 space-y-4 min-w-0">
                ...
                {selectedCountry === 'Brasil' && (
                  <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 flex items-start gap-3 mt-6">
                    <ShieldCheck className="w-6 h-6 text-violet-700 shrink-0 mt-0.5" />
                    <div>
                  ...
                  <div className="space-y-3 pt-2 border-t border-border">
                    ...
                    {activeCoupon && (
                      <div className="space-y-1.5">
                        ...
                        {hasPromoItems && regularSubtotal === 0 && (
                          <p className="text-[11px] text-violet-700 font-semibold bg-purple-50 border border-purple-200 rounded-lg px-2 py-1.5 leading-snug">
                    ...
                    <div className="flex justify-between pt-3 border-t border-border">
                      ...
                      <div className="text-right">
                        ...
                        <span className="font-black text-2xl text-violet-700">
